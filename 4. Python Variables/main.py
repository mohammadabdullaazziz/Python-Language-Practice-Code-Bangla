...
# ভেরিয়েবলগুলো প্রিন্ট করে দেখা যাক
print(name)
print(age)
print(gpa)
...
একটি ভেরিয়েবলের নাম পাইথনের কোনো কীওয়ার্ড হতে পারে না। রিজার্ভড কিওয়ার্ড (Reserved Keywords): Python-এর নিজস্ব কিছু সংরক্ষিত শব্দ আছে (যেমন: if, else, print, while, for)। এগুলোকে ভেরিয়েবলের নাম হিসেবে ব্যবহার করা যাবে না।
...
Python একটি ডাইনামিকালি টাইপড ভাষা। এর মানে হলো,  একটি ভেরিয়েবলে প্রথমে এক ধরণের ডেটা রাখার পর পরবর্তীতে একই ভেরিয়েবলে অন্য ধরণের ডেটা রাখতে পারেন। Python নিজে থেকেই তার টাইপ বদলে নেয়।
