...
num = 20.1234123  # এটি একটি ফ্লোট (Float) নম্বর

# f-string ব্যবহার করে দশমিকের পর ৩ ঘর রেখে স্ট্রিং বানিয়ে ফেলা হলো
kk = f"{num:.3f}" 

print(kk)   # আউটপুট: "20.123" (এটি একটি স্ট্রিং)
print(num)  # আউটপুট: 20.1234123 (আসল মূল সংখ্যাটি অপরিবর্তিত আছে)

print(type(kk))   # <class 'str'> (কারণ এটি স্ট্রিং হয়ে গেছে)
print(type(num))  # <class 'float'> (কারণ আসল ভ্যারিয়েবল পরিবর্তন হয়নি)
...
print(kk)   # আউটপুট: 20.123 (এটি একটি নম্বর)
print(type(kk))   # <class 'float'> (টাইপ নম্বরই থাকবে)
...
# str() ফাংশন দিয়ে সংখ্যাটিকে স্ট্রিংয়ে রূপান্তর করা হলো
kk = str(num)

print(kk)         # আউটপুট: "2023"
print(num)        # আউটপুট: 2023 (আসল মূল সংখ্যাটি অপরিবর্তিত আছে)

print(type(kk))   # <class 'str'> (এটি এখন স্ট্রিং)
print(type(num))  # <class 'int'> (আসল ভ্যারিয়েবলটি নম্বর বা ইন্টিজারই আছে)
...
জাভাস্ক্রিপ্টের parseInt() Vs Python

১. সাধারণ স্ট্রিংকে পূর্ণসংখ্যায় রূপান্তর ("100")
জাভাস্ক্রিপ্টের মতো পাইথনেও int() ফাংশন দিয়ে সাধারণ সংখ্যাযুক্ত স্ট্রিংকে ইন্টিজারে রূপান্তর করা যায়।
আর পাইথনের স্ট্রিমে থাকা বাড়তি স্পেস বা হোয়াইটস্পেস এটি নিজে থেকেই ইগনোর করতে পারে:

# স্পেসসহ বা সাধারণ স্ট্রিং রূপান্তর
kk = int("  50  ")

print(kk)          # আউটপুট: 50
print(type(kk))    # আউটপুট: <class 'int'>



২. দশমিকযুক্ত স্ট্রিং রূপান্তর ("45.89")
জাভাস্ক্রিপ্টের parseInt("45.89") যেমন দশমিক বাদ দিয়ে শুধু 45 দেয়, পাইথনে সরাসরি int("45.89") দিলে কিন্তু এরর (ValueError) আসবে। 
কারণ পাইথন সরাসরি ফ্লোট স্ট্রিংকে int() বানাতে পারে না।

এটি করার জন্য প্রথমে স্ট্রিংটিকে float-এ এবং পরে int-এ রূপান্তর করতে হয়:

# প্রথমে float-এ রূপান্তর করে দশমিক বাদ দেওয়ার জন্য int করা হলো
kk = int(float("45.89"))
...
৩. সংখ্যা এবং টেক্সট একসাথে থাকলে ("200px")
জাভাস্ক্রিপ্টের parseInt("200px") খুব চালাক—সে শুরু থেকে সংখ্যাগুলো নিয়ে টেক্সট (px) বাদ দিয়ে দেয় (200 দেয়)। কিন্তু পাইথনের int("200px") সরাসরি দিলে এরর আসবে।

পাইথনে এই কাজটি করতে হলে রেগুলার এক্সপ্রেশন (re মডিউল) অথবা পাইথনের বিল্ট-ইন স্ট্রিং ফিল্টারিং ব্যবহার করতে হয়। সবথেকে সহজ উপায় হলো:
...
# রেগুলার এক্সপ্রেশন দিয়ে শুধু সংখ্যাগুলো খুঁজে বের করা
...
সাধারণ স্ট্রিং ও স্পেসের ক্ষেত্রে পাইথনের int() সরাসরি জাভাস্ক্রিপ্টের মতো কাজ করে।

দশমিক স্ট্রিংয়ের জন্য int(float(...)) ব্যবহার করতে হয়।

আর "200px" এর মতো টেক্সটমিশ্রিত স্ট্রিং থেকে সংখ্যা তুলতে re মডিউলের সাহায্য নিতে হয়।





num = "2028"  # এটি একটি স্ট্রিং (String)

# int() ফাংশন ব্যবহার করে স্ট্রিং থেকে নম্বর বানিয়ে kk-তে রাখা হলো
kk = int(num)

print(kk)          # আউটপুট: 2028
print(num)         # আউটপুট: 2028 (আসল মূল ভ্যারিয়েবলটি স্ট্রিংই রয়ে গেছে)

print(type(kk))    # আউটপুট: <class 'int'> (কারণ এটি এখন একটি নম্বর)
print(type(num))   # আউটপুট: <class 'str'> (আসল ভ্যারিয়েবল পরিবর্তন হয়নি)

এখানে জাভাস্ক্রিপ্টের parseInt() এর মতোই পাইথনের int(num) কাজ করেছে—kk তে সংখ্যা চলে এসেছে, 
কিন্তু আসল num ভ্যারিয়েবলটি অপরিবর্তিত স্ট্রিং (str) হিসেবেই থেকে গেছে।
...
# জাভাস্ক্রিপ্টের parseFloat এর মতো কাজ করার জন্য একটি ছোট ফাংশন তৈরি করে নেওয়া ভালো
def parse_float(text):
    # শুরু থেকে ফ্লোট নাম্বার বা সংখ্যা প্যাটার্ন খুঁজে বের করা
    match = re.search(r'^\s*(-?\d+(?:\.\d+)?)', text)
    if match:
        return float(match.group(1))
    return None

# ১. সাধারণ দশমিক সংখ্যা (Float string)
num1 = "10.50"
kk1 = float(num1)
print(kk1)       # আউটপুট: 10.5 (পাইথনে ফ্লোট প্রিন্ট হলে শেষের জিরো বাদ হয়ে যায়)

# ২. সংখ্যার পরের টেক্সট বাদ দেওয়া
num2 = "45.89px"
kk2 = parse_float(num2)
print(kk2)       # আউটপুট: 45.89

# ৩. দ্বিতীয় ডটের পর থেকে বাদ দেওয়া
num3 = "3.14.15"
kk3 = parse_float(num3)
print(kk3)       # আউটপুট: 3.14

# ৪. স্পেস ইগনোর করা (পাইথনের নিজস্ব float() ফাংশনই স্পেস রিমুভ করতে পারে)
num4 = "  99.9  "
kk4 = float(num4)
print(kk4)       # আউটপুট: 99.9



# int() ফাংশন দিয়ে বুলিয়ানকে নম্বরে রূপান্তর
print(int(True))   # আউটপুট: 1
print(int(False))  # আউটপুট: 0

# এমনকি float() দিলেও একই ফল আসবে
print(float(True))  # আউটপুট: 1.0
print(float(False)) # আউটপুট: 0.0

যেহেতু পাইথনে True মানে 1 আর False মানে 0, তাই সরাসরি এগুলো দিয়ে গাণিতিক হিসাব! যেমন:

print(True + True)   # আউটপুট: 2 (কারণ 1 + 1)
print(True * 5)      # আউটপুট: 5 (কারণ 1 * 5)
print(False + 10)    # আউটপুট: 10 (কারণ 0 + 10)
...
math.isnan()
জাভাস্ক্রিপ্টের কঠোর Number.isNaN() এর সমতুল্য পাইথনের উপায় হলো math.isnan()।

এটি ব্যবহার করতে হলেও প্রথমে math মডিউল ইমপোর্ট করে নিতে হয়। 
জাভাস্ক্রিপ্টের Number.isNaN() এর মতোই পাইথনের math.isnan() অত্যন্ত কঠোর—ইনপুটটি যদি সরাসরি ফ্লোট টাইপের NaN (Not a Number) না হয়, 
তবে এটি কোনো টাইপ কনভার্শন না করে সরাসরি TypeError দিয়ে দেয়।


import math

# ১. সরাসরি NaN হলে True দেবে
print(math.isnan(float('nan')))  # আউটপুট: True

# ২. সাধারণ সংখ্যা হলে False দেবে
print(math.isnan(100))           # আউটপুট: False

# ৩. স্ট্রিং বা অন্য কিছু দিলে জাভাস্ক্রিপ্টের মতো false না দিয়ে পাইথনে সরাসরি TypeError আসবে
# print(math.isnan("hello"))     # TypeError: must be real number, not str

পাইথনের math.isnan() ফাংশনটি খুব কড়াকড়িভাবে চেক করে যে মানটি আসলেই NaN (Not a Number) কি না।

নিচে কোন কোন মানের জন্য এটি True বা False রিটার্ন করে এবং কোনগুলোতে এরর দেয় তা তালিকা আকারে দেওয়া হলো:

১. যেগুলোর জন্য True রিটার্ন করে:
শুধু এবং কেবলমাত্র তখনই এটি True দেবে যখন মানটি সরাসরি NaN হবে:

float('nan') বা math.nan

কোনো ভুল বা অনির্ণেয় গাণিতিক অপারেশনের ফলাফল (যেমন: float('inf') - float('inf') বা 0.0 / 0.0)


import math

print(math.isnan(float('nan')))  # আউটপুট: True
print(math.isnan(math.nan))      # আউটপুট: True
print(math.isnan(0.0 / 0.0))     # আউটপুট: True

২. যেগুলোর জন্য False রিটার্ন করে:
যেকোনো সাধারণ সংখ্যা বা এমনকি অসীম (Infinity) হলেও এটি False রিটার্ন করবে (কারণ ইনফিনিটি একটি সংখ্যা, যদিও তা অসীম):

সাধারণ পূর্ণসংখ্যা বা দশমিক সংখ্যা (যেমন: 10, -5.5, 0)

ধনাত্মক বা ঋণাত্মক অসীম (float('inf'), -float('inf')) — মনে রাখবেন, ইনফিনিটি কিন্তু NaN নয়, তাই এটি False দেবে।


import math

print(math.isnan(100))           # আউটপুট: False (এটি একটি সাধারণ সংখ্যা)
print(math.isnan(0))             # আউটপুট: False 
print(math.isnan(float('inf')))  # আউটপুট: False (এটি ইনফিনিটি, NaN নয়)

৩. যেগুলোতে TypeError আসবে (কোনো True/False দেবে না):
যেহেতু এটি জাভাস্ক্রিপ্টের কঠোর Number.isNaN() এর মতো কাজ করে, তাই ইনপুট যদি সরাসরি সংখ্যা বা ফ্লোট না হয়ে অন্য কিছু হয়, তবে পাইথন কোনো ফলাফল না দিয়ে সরাসরি এরর দিয়ে কোড থামিয়ে দেবে:

স্ট্রিং (যেমন: "hello", "123")

বুলিয়ান (True, False)

লিস্ট বা অন্য ডেটা টাইপ

import math

# এগুলোতে সরাসরি TypeError আসবে:
...
-
math.isfinite()
পাইথনের math.isfinite() ফাংশনটি মূলত কোনো সংখ্যা সসীম (finite) কি না তা যাচাই করে। এটি ইনপুট হিসেবে একটি সংখ্যা নিয়ে ফলাফল হিসেবে True অথবা False রিটার্ন করে।

১. যেগুলোর জন্য True রিটার্ন করে (অর্থাৎ যেগুলো সসীম সংখ্যা):
সাধারণ পজিটিভ বা নেগেটিভ পূর্ণসংখ্যা (যেমন: 10, -5)

যেকোনো দশমিক বা ফ্লোট সংখ্যা (যেমন: 3.14, -0.005)

শূন্য (0)

২. যেগুলোর জন্য False রিটার্ন করে (অর্থাৎ যেগুলো সসীম নয়):
ধনাত্মক অসীম সংখ্যা (float('inf'))

ঋণাত্মক অসীম সংখ্যা (-float('inf'))

সংখ্যা নয় বা NaN (float('nan'))

import math

# True রিটার্ন করার উদাহরণ (সবগুলোই সসীম সংখ্যা)
print(math.isfinite(100))        # আউটপুট: True
print(math.isfinite(-45.5))      # আউটপুট: True
print(math.isfinite(0))          # আউটপুট: True

# False রিটার্ন করার উদাহরণ (অসীম বা ভুল সংখ্যা)
print(math.isfinite(float('inf')))   # আউটপুট: False (Infinity)
print(math.isfinite(-float('inf')))  # আউটপুট: False (-Infinity)
print(math.isfinite(float('nan')))   # আউটপুট: False (Not a Number)

পাইথনে কোনো সংখ্যা ইনফিনিটি (inf) বা ন্যান (nan) ছাড়া সাধারণ কোনো বাস্তব সংখ্যা কি না—তা নিশ্চিত করার জন্যই মূলত math.isfinite() ব্যবহার করা হয়।



ট্রানজ্যাকশন অ্যামাউন্ট ভ্যালিডেশন (Finite Check)
ব্যাকএন্ডে কোনো পেমেন্ট বা ট্রানজ্যাকশন অ্যামাউন্ট প্রসেস করার আগে নিশ্চিত হতে হয় যে মানটি কোনো ইনফিনিটি (inf) বা মিসিং ডেটা (nan) নয়,
বরং একটি সাধারণ ও সঠিক সংখ্যা (Finite Number) কিনা।
...
জাভাস্ক্রিপ্টের Number.isInteger() এর মতো সরাসরি একই নামের ফাংশন পাইথনে না থাকলেও, এই কাজটি করার জন্য পাইথনে অত্যন্ত চমৎকার এবং সহজ দুটি পদ্ধতি রয়েছে।

১. ডেটা টাইপ চেক করতে: isinstance()
যদি নিশ্চিত হতে চাওয়া হয় যে কোনো ভেরিয়েবলের মানটি সরাসরি একটি পূর্ণসংখ্যা (int) কি না, তবে পাইথনের বিল্ট-ইন isinstance() ফাংশন ব্যবহার করা যাবে।

x = 10
y = 10.5

print(isinstance(x, int))  # আউটপুট: True (কারণ এটি পূর্ণসংখ্যা)
print(isinstance(y, int))  # আউটপুট: False (কারণ এটি দশমিক বা float)

(উল্লেখ্য: এখানে 5 হলো ইন্টিজার, কিন্তু 5.0 কে পাইথন ফ্লোট হিসেবে ধরে, তাই isinstance(5.0, int) দিলে False আসবে।)

২. ফ্লোট সংখ্যার ভেতর পূর্ণসংখ্যা চেক করতে: .is_integer()
যদি কোনো ফ্লোট সংখ্যা থাকে (যেমন: 5.0), এবং দেখতে চাওয়া হসছে সেটি দেখতে দশমিক হলেও আসলে কোনো পূর্ণসংখ্যা কি না,
তবে ফ্লোটের নিজস্ব মেথড .is_integer() ব্যবহার করা যাবে।

a = 5.0
b = 5.5

print(a.is_integer())  # আউটপুট: True (কারণ ৫.০ মানে মূলত ৫)
print(b.is_integer())  # আউটপুট: False (কারণ ৫.৫ একটি ভাঙা সংখ্যা)
