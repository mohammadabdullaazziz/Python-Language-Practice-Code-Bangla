...
কম্পিউটার আমাদের দেওয়া দশমিক সংখ্যাগুলোকে ব্যাকএন্ডে বাইনারি (০ এবং ১) আকারে জমা রাখে। কিছু কিছু দশমিক সংখ্যাকে বাইনারিতে নিখুঁতভাবে প্রকাশ করা যায় না 
(যেমনটা আমরা 1 কে 3 দিয়ে ভাগ করলে 0.3333... পাই, যা কখনো শেষ হয় না)।
...
ফ্লোট সংখ্যা রাউন্ড বা ছোট করা (round())
দশমিকের পরে অনেকগুলো ঘর থাকলে তা পড়ার সুবিধার জন্য ছোট করতে round(সংখ্যা, ঘরের_সংখ্যা) ফাংশন ব্যবহার করা হয়।

pi = 3.1415926535
# দশমিকের পর ২ ঘর পর্যন্ত রাখতে চাই
print(round(pi, 2))  # আউটপুট আসবে: 3.14


float-এর গুরুত্বপূর্ণ ফাংশন

# ১. টাইপ কনভার্শন
float("3.14")     # স্ট্রিং → float → ৩.১৪
float(5)          # int → float → ৫.০
int(3.99)         # float → int → ৩ (দশমিক অংশ কেটে যায়)
round(3.1416, 2)  # ২ দশমিকে রাউন্ড → ৩.১৪
